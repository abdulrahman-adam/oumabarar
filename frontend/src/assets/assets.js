...
export const footerLinks = [
  ...
  },
  {
    title: "Besoin d'aide ?",
    links: [
      { text: "Informations de Livraison", url: "/add-address" },
      { text: "Politique de Retour & Remboursement", url: "#" },
      { text: "Moyens de Paiement", url: "#" },
      { text: "Suivre votre Commande", url: "/my-orders" },
      { text: "Contactez-nous", url: "/contact" },
    ],
  },
  {
...
export const features = [
  {
    ...
    description: "Vos courses livrées à domicile en moins de 30 minutes.",
  },
  {
    icon: leaf_icon,
    title: "Fraîcheur Garantie",
    description: "Des produits frais provenant directement de la source.",
  },
  {
    icon: coin_icon,
    title: "Prix Abordables",
    description: "Des produits de qualité à des prix imbattables.",
  },
  {
    icon: trust_icon,
    title: "Approuvé par des Milliers",
    description: "Déjà adopté par plus de 10 000 clients satisfaits.",
  },
];
